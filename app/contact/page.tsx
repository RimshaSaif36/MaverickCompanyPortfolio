...
export default function ContactPage() {
  ...
  const infoCards = [
    ...
    },
    {
      ...
      title: "Call Us",
      lines: ["+92 310 3395111", "Mon – Sat: 9am – 6pm PKT"],
    },
    {
    ...
    },
    {
      ...
      lines: ["Monday – Friday: 9am – 6pm", "Saturday: 10am – 3pm", "Sunday: Closed"],
    },
  ];
            ...
            {infoCards.map(({ icon, title, lines }, i) => (
              <div
                ...
                className={`p-8 flex flex-col gap-4 ${
                  i === 0 ? "bg-[#998100]" : "bg-[#252525] border-l border-white/5"
                }`}
              >
              ...
              <div className="bg-[#1a1a1a] p-8">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { label: "Twitter / X", handle: "@MaverickTech", color: "#1DA1F2" },
